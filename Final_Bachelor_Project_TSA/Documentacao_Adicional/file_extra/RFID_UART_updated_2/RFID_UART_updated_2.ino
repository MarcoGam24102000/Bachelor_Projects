...
int timeFromInitTimer = 0;

int64_t timeRFID_tagGone = 0;

float timerFromInTimerSec = 0;

int timeRFID_lastOne = 0;
                ...
                if(i == tag.dataLen - 1){
                  ...
                  for(int indic=0; indic < tag.dataLen; indic++){
                     ...
                     if(indic == tag.dataLen - 1){
                        ...
                        if((RFID.cardNumber() != 0)  && (tag.raw != 0)){ 
                          count++;
                          ...
                          timeRFID_tagGone = esp_timer_get_time()/1000-timeRFID_lastOne ;

                          timeFromInitTimer = timeRFID_tagGone/2;

                          timerFromInTimerSec = timeFromInitTimer/1000;
                        }                        
                     }
